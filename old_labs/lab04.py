...
#Randomly choose monsters magic power
...
loot_item1_index = random.choice(list(range(0, 5)))
loot_item_1= loot_options.pop(loot_item1_index)
...
loot_item2_index = random.choice(list(range(0, 4)))
loot_item_2= loot_options.pop(loot_item2_index)
belt.append(loot_item_2)
print(f"You now have {belt}")

#Organzise the loot belt
print("Belt is being sorted in alphabetical order")
belt.sort()
print(belt)

# use the first loot item
print("use your first loot item from your belt")
use_item = belt.pop(0)
